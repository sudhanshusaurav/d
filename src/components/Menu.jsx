...
function Menu({menuActive}) {
  return <nav className={`fixed top-0 left-0 w-full h-full bg-black/10 menu ${menuActive ? 'menu--open' : ''}`}>
      <ul className='flex flex-col items-start justify-start p-16 h-full w-3/4 lg:w-2/3 bg-white ml-auto'>
        ...
        <li className='my-2'><Link to='' className='nav__link hoverable'>Process</Link></li>
        <li className='my-2'><Link to='' className='nav__link hoverable'>Work</Link></li>
        <li className='my-2'><Link to='' className='nav__link hoverable'>Service</Link></li>
        <li className='my-2'><Link to='' className='nav__link hoverable'>Us</Link></li>
        <li className='my-2'><Link to='' className='nav__link hoverable'>Contact</Link></li>
